...
const translations = reactive({
  en: {
    ...
    cardChartType: 'Card Chart Type',
    cardChartBar: 'Bar Chart',
    cardChartRing: 'Ring Chart',
    cardChartTypeTip: 'Switches the dashboard server cards between compact bars and ring gauges.',
  ...
  zh: {
    ...
    cardChartType: '卡片图表样式',
    cardChartBar: '条形图',
    cardChartRing: '环形图',
    cardChartTypeTip: '在仪表盘服务器卡片的紧凑条形图和环形仪表样式之间切换。',
    displayOptions: '显示选项',
    publicAccess: '公开访问',
    showPrice: '显示价格',
    showExpire: '显示到期时间',
